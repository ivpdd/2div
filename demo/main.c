...
int main() {
	...
	divplaysnd(&sound);
	int circlespin = 0;
	Body *dynamictux = divphysaddbody((Vector2){100,100},(Vector2){100,100},90,1,true);
	Body *ground = divphysaddbody((Vector2){0,640},(Vector2){640,100},0,1,false);
